      ...
      <div className="w-full max-w-[380px] animate-float-in">
        ...
        <div className="flex flex-col items-center text-center mb-8">
          ...
          <p className="text-[13px] mt-1.5 max-w-[260px]" style={{ color: 'var(--text-muted)' }}>
            Sign in to your Tindahan store
          </p>
        </div>
        ...
        <div className={`surface p-6 ${animError ? 'animate-shake' : ''}`}>
          <form onSubmit={handleSubmit} className="space-y-5">
            ...
            {error && (
              <div
                className="p-3 rounded-lg text-[12.5px] font-medium flex items-center gap-2"
            ...
            <div className="float-input">
              ...
              <button
                ...
                className="absolute right-[10px] top-1/2 -translate-y-1/2 w-8 h-8 flex items-center justify-center rounded-md transition-colors"
